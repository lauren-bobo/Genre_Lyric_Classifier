...
def train_and_evaluate_model_cv(X_train, Y_train):
    print("Training and Evaluating Naive Bayes Model with 10-Fold Cross-Validation...")
...
nb_model_1 = train_and_evaluate_model_cv(X_train_1, Y_train_1)
with open('nb_model_1.pkl', 'wb') as f:
...
nb_model_2 = train_and_evaluate_model_cv(X_train_2, Y_train_2)
with open('nb_model_2.pkl', 'wb') as f:
...
nb_model_3 = train_and_evaluate_model_cv(X_train_3, Y_train_3)
with open('nb_model_3.pkl', 'wb') as f:
