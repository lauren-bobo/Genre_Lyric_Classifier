...
X_split4 = split_4[0]  
Y_split4 = split_4[2]  
split4_predictions = logreg_model.predict(X_split4)

with open('logreg_predictions_split4.pkl', 'wb') as f:
...
print("Logistic Regression Model, TF-IDF Vectorizer, and Split 4 Predictions Saved Successfully!")
